...
void MyGLWidget::carregaTerra(){
  ...
  Colors[0] = glm::vec3(182.0/255.0, 149.0/255.0, 192.0/255.0);
  Colors[1] = glm::vec3(182.0/255.0, 149.0/255.0, 192.0/255.0);
  Colors[2] = glm::vec3(182.0/255.0, 149.0/255.0, 192.0/255.0);
  Colors[3] = glm::vec3(182.0/255.0, 149.0/255.0, 192.0/255.0);


    glGenVertexArrays(1, &VAO_Terra);
  glBindVertexArray(VAO_Terra);

    tribPointer(vertexLoc, 3, GL_FLOAT, GL_FALSE, 0, 0);
  glEnableVertexAttribArray(vertexLoc);
