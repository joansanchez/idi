...
void MyGLWidget::initializeGL ()
{
  ...
  escena = 0;
  posiciomodel = glm::vec3 (0, -1+0.15,0);
  apagar = false;
...
void MyGLWidget::paintGL ()
{
  ...
  std::cout<< "posició focus: ("<<posFocusescena[0]<<","<<posFocusescena[1]<<","<<posFocusescena[2]<<")"<<std::endl;
  std::cout<< "color focus: ("<<colFocusaux[0]<<","<<colFocusaux[1]<<","<<colFocusaux[2]<<")"<<std::endl;
  std::cout<<std::endl;
...
// Creació del Vertex Array Object del terra
  ...
  //enviem color de focus i la seva posicio
  posFocusaux = glm::vec3(0,0,0);
  colFocusaux = glm::vec3(1,1,0);
  glUniform3fv(matrixposfocus, 1, &posFocusaux[0]);
  glUniform3fv(matrixcolorfocus, 1, &colFocusaux[0]);
...
void MyGLWidget::carregaShaders()
{
  ...
  matrixposfocus = glGetUniformLocation (program->programId(), "posFocus");
  matrixcolorfocus = glGetUniformLocation (program->programId(), "colFocus");
...
void MyGLWidget::modelTransformPatricio ()
{
  ...
  //TG = glm::scale(TG, glm::vec3(novaescala, novaescala, novaescala));
  TG = glm::translate(TG, posiciomodel);
...
void MyGLWidget::keyPressEvent(QKeyEvent* event)
{
  ...
  switch (event->key()) {
    ...
    case Qt::Key_F:{
      if (escena == 1){
        posFocusescena = glm::vec3(0,-0.5,0);
        escena = 0;
        glUniform3fv(matrixposfocus, 1, &posFocusescena[0]);
      }
      else {
        posFocusaux = glm::vec3(0,0,0);
        escena = 1;
